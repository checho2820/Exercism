"""
Guido's Gorgeous Lasagna at exercism.com
"""
...
def preparation_time_in_minutes(layers):
    ...
    This function takes one number representing
    the number of layers the lasagna has
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    representing the number of layers & the time already spent
